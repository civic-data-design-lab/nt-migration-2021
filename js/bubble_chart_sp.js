...
const pathwayAttr = {
    "regular": {"label": "A través de un Mecanismo Regular", "color": "#e23cad"},
    "irrregular coyote": {"label": "Usando un Traficante o Coyote para Migrar", "color": "#662d91"},
    "irregular on own, with caravan": {"label": "Migró por Cuenta Propia o en Caravana", "color": "#faa41a"}
};

const financeText = {
    "1": {"label":"Sin Respuesta"}
};
...
var meansCenters = {
  ...
  var yearsTitleX = {
    "Migrantes Gastaron": 180,  //  $1.2 Billion Migrants Spend to Migrate
    "Migrantes Gastaron ": width / 2.2,  // $450 Million Billion Migrants Spend to Migrate
    "Migrantes Gastaron  ": width - 310   // {$520 Million Migrants Spend to Migrate}
  };
  
var yearsTitleX2 = {
    "$1.2 Mil Millones": 180,  //  $1.2 Billion Migrants Spend to Migrate
    "$520 Mil Millones": width / 2.2,  // $450 Million Billion Migrants Spend to Migrate
    "$450 Mil Millones": width - 310   // {$520 Million Migrants Spend to Migrate}
  };
...
var meansTitleX = {
    "Mecanismos Regulares": 120,
    "Mecanismos Irregulares": width - 490
   //  "Irregular Pathway": width - 250
  };
  
var meansTitleX2 = {
    "$240 Million": 120,
    "$2.0 Mil Millones": width - 490
   //  "Irregular Pathway": width - 250
  };
  
var meansTitleX3 = {
    "Migrantes Gastaron para Migrar": 120,
    "Migrantes Gastaron para Migrar  ": width - 490
   //  "Irregular Pathway": width - 250
  };
 ...
 var financeTitleX = {
   ...
   var financeTitleX2 = {
    "Financiaron la Migración ": 330,
    "Financiaron la Migración": width - 720,
    "Financiaron la Migración  ": width - 320
  };
  
     var financeTitleX3 = {
    "Completamente con Préstamos": 330,
    "Parcialmente con Préstamos": width - 720,
    "Sin Préstamo Alguno": width - 320
  };
...
.append('text')
  ...
  .text("gastado por el Departamento de Seguridad Nacional de los Estados Unidos para Detener a Salvadoreños, Guatemaltecos y Hondureños en la Frontera Suroeste.")
  .call(wrap,250);
  }
...
const annotations5 = [
  {
    note: { label: "En promedio, el migrante tarda 20 meses en pagar el costo.",
    title: "20 meses de deuda por Migrar con Traficante o Coyote de Forma Irregular" },
    subject: {
              x1: 1500,
              x2: 100 
            },
...
d3.select("svg")
  ...
  d3.selectAll(".annotation text").attr("transform", "translate(800,-203)");
  }
...
d3.selectAll(".annotation-groupe").style("opacity",1);
  ...
  const annotations6 = [
  {
    note: { label: "En promedio, el migrante tarda 7 meses en pagar el costo.",
    title: "7 meses de deuda por Migrar con por Cuenta Propia o en Caravana" },
    subject: {
              x1: 1500,
              x2: 100 
            },
...
d3.select("svg")
  ...
  d3.selectAll(".annotation text").attr("transform", "translate(800,-163)");
  }
...
d3.selectAll(".annotation-groupf").style("opacity",1);
  ...
  {
    note: { label: "En promedio, el migrante tarda 7 meses en pagar el costo.",
    title: "10 de meses deuda por Migrar con Mecanismos Regulares" },
    subject: {
              x1: 1500,
              x2: 100 
            },
...
d3.select("svg")
  ...
  d3.selectAll(".annotation text").attr("transform", "translate(800,-162)");
  }
...
.append('text')
  ...
  .text("Gasto Viajando con Traficante o Coyote.")
  .call(wrap,250);
  }
...
.append('text')
  ...
  .text("Gasto Viajando en Cuenta Propia o en Caravana")
  .call(wrap,250);
  }
...
.attr('class', "annotation-note-title  totlabcost")	
  .text("Gasto Anual Estimado en 2021 de los migrantes que viajan a EE. UU. desde Centroamerica");
  }
...
.attr('class', "annotation-note-title  finlabcost")	
  .text("Financiando Migración a EE.UU.");
  }
